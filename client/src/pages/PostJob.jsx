...
import { ArrowLeft, Briefcase, DollarSign, Calendar, MapPin, Building, FileText, CheckSquare, List } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
          <div className="bg-black text-white p-8">
              ...
              <p className="text-gray-400 mt-2">Create a new opportunity for students.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-8">
              ...
              <section>
                  ...
                  <div className="space-y-2">
                      ...
                      {formData.interviewRounds.length === 0 && (
                          <p className="text-sm text-gray-500 text-center italic">No interview rounds added yet.</p>
                      )}
                  </div>
              </section>
              ...
              <div className="pt-6 border-t border-gray-100 flex justify-end">
                  <button 
                      type="submit" 
                      className="bg-black text-white px-8 py-3 rounded-xl font-bold text-lg hover:bg-gray-800 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                  >
                      🚀 Publish Job
                  </button>
              </div>
